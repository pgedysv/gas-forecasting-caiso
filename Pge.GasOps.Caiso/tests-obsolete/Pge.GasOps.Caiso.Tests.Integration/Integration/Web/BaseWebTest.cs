...
using Pge.GasOps.Caiso.Web.NetCore;
    ...
    public abstract class BaseWebTest
    {
        ...
        protected HttpClient GetHttpClient()
        {
            ...
            var builder = new WebHostBuilder()
                ...
                .ConfigureServices((Action<IServiceCollection>)InitializeServices)
                .UseStartup<Startup>()
        ...
        private static string GetProjectPath(string solutionRelativePath, Assembly startupAssembly)
        {
            ...
            do
            {
                var solutionFileInfo = new FileInfo(Path.Combine(directoryInfo.FullName, "Pge.GasOps.Caiso.sln"));
